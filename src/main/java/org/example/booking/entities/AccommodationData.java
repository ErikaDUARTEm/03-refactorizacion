...
public class AccommodationData {
    ...
    public List<Apartament> listApartaments() {
        return List.of(
                new Apartament("Apartamento", "San Gil Natural", "San Gil", "San Gil Natural ofrece un entorno tranquilo...", 4.8, 0.0,
                        List.of(
                ...
                new Apartament("Apartamento", "Puente de la Villa", "San Gil", "Puente de la Villa ofrece apartamentos modernos con vistas al puente y la ciudad desde sus balcones.", 4.6, 0.0,
                        List.of(
    ...
    public List<Finca> listFincas() {
        return List.of(
                new Finca("Finca", "Finca Sol y Luna", "San Gil", "Finca Sol y Luna se encuentra en San Gil...", 4.3, 0.0,
                        List.of(new Room("single room", "cama individual, baño privado, aire acondicionado",1, 1, 45.0, 1),
                                ...
                                new Room("quadruple room", "4 camas, baño privado, aire acondicionado, vista al campo", 4, 4, 110.0, 2),
